  ...
  return (
    <main>
      <div id="developers" className="container-fluid">
        <div className="card" style={{ width: '20rem' }}>
          ...
          <div className="card-body">
            ...
            <p className="card-text">Detail-oriented with a keen eye for design and user experience. Enthusiastic about creating visually appealing and user-friendly websites.Excited for the journey ahead and eager to contribute innovative ideas to the digital landscape</p>
          </div>
      ...
      <section className="pb-5 pt-0">
                ...
                <form>
                  ...
                  <div className="row mt-4">
                    <div className="col text-center">
                      <button type="submit" className="btn btn-outline-light mb-5">Submit</button>
                    </div>
                  </div>
                </form>
              </div>
        ...
        <div className="container-fluid p-0 pb-3 map-map">
